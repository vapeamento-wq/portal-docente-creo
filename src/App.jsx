...
// --- CONFIGURACIÓN BLINDADA (Sin process.env que causa pantalla blanca) ---
...
const App = () => {
  ...
  const handleSearch = (e) => {
    ...
    if (idBusqueda) {
      ...
      // Usamos try/catch para evitar cualquier error de red que bloquee la app
      try {
        ...
        }).catch(err => console.log("Error silencioso log:", err));
