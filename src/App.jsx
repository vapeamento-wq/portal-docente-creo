...
const WHATSAPP_NUMBER = "573106964025"; // Número actualizado
...
const App = () => {
  ...
  useEffect(() => {
    if (!URL_CSV) {
      setState(s => ({ ...s, loading: false, error: "Error: Variable de entorno no configurada en Vercel." }));
      return;
    }
    ...
    <div className="portal-container">
      <style>{`
        :root {
          --primary: #003366;
          --secondary: #D4AF37;
          --orange: #FF6600; /* Naranja Institucional */
          --bg: #f4f6f8;
          --text: #333;
          --white: #ffffff;
        }
